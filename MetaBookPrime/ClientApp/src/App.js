...
import EventForm from './applications/Moments/EventForm';
    ...
    render() {
        return (
            <Layout>
                ...
                <Route exact strict path='/events/edit/:id' component={EventForm}/>
                <AuthorizeRoute exact strict path='/events/add/' component={EventForm}/>
